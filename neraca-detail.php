...
<body>
    ...
    <div class="page-container">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="neraca-detail.php" class="active" data-tooltip="Neraca"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M21.49 10.75-2.2 5.56l1-3.81 22.69 5.19zM2.81 7.4L1 11.21l10.51 2.4-1.7-6.21zm20.28.02-9.51-2.15-1.7 6.21L23.09 9zM12 15.19l-9-2.07L1 17l11 2.54L23 17l-2.09-3.88z"/></svg></span></a></li>
                </ul>
            </nav>
        ...
        <main class="main-content">
            <h1 class="page-title">Neraca Detail</h1>
            <?php foreach (['aset', 'liabilitas', 'modal'] as $tipe): ?>
                <div class="card-theme">
                    <div class="card-header-theme"><?= ucfirst($tipe) ?></div>
                    <div class="card-body-theme">
                        <table class="table-dark-theme">
                            <thead><tr><th>Kode Akun</th><th>Nama Akun</th><th class="text-end">Total</th></tr></thead>
                            <tbody>
                                <?php if (count($neraca_detail[$tipe]) > 0): ?>
            ...
            <div class="btn-group">
                ...
                <a href="export-neraca.php" class="btn-theme btn-outline-success">Export Excel</a>
                <a href="index.php" class="btn-theme btn-secondary">Kembali</a>
            </div>
        </main>
    </div>
