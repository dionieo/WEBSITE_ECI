...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .table-dark-theme th, .table-dark-theme td { padding: 1rem 1.5rem; border-bottom: 1px solid var(--border-color); text-align: left; }
        .table-dark-theme tr:last-child th, .table-dark-theme tr:last-child td { border-bottom: none; }
        .table-dark-theme .text-end { text-align: right; }
        .table-dark-theme .total-row { background-color: var(--accent-color); color: var(--text-primary); font-weight: bold; }
        ...
        .btn-outline-primary { background: transparent; color: var(--accent-color); border: 1px solid var(--accent-color); }
        .btn-outline-primary:hover { background: var(--accent-color); color: var(--text-primary); }
        .btn-outline-success { background: transparent; color: var(--success-color); border: 1px solid var(--success-color); }
        .btn-outline-success:hover { background: var(--success-color); color: var(--text-primary); }
    </style>
</head>
<body>
    ...
    <div class="page-container">
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="laporan.php" class="active" data-tooltip="Laporan Keuangan"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M5 9.2h3V19H5zM10.6 5h2.8v14h-2.8zm5.6 8H19v6h-2.8z"/></svg></span></a></li>
                </ul>
            </nav>
        ...
        <main class="main-content" style="max-width: 900px; margin: 0 auto;">
            ...
            <div class="card-theme">
                <div class="card-header-theme">Laporan Laba Rugi</div>
                <div class="card-body-theme">
                    <table class="table-dark-theme">
                        <tr>
                            <td>Pendapatan</td>
                            <td class="text-end">Rp <?= number_format($laba_rugi['pendapatan']) ?></td>
                        </tr>
                        <tr>
                            <td>Beban</td>
                            <td class="text-end">Rp <?= number_format($laba_rugi['beban']) ?></td>
                        </tr>
                        <tr class="total-row">
                            <th>Laba/Rugi Bersih</th>
                            <th class="text-end">Rp <?= number_format($laba_rugi['pendapatan'] - $laba_rugi['beban']) ?></th>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="card-theme">
                <div class="card-header-theme">Neraca</div>
                <div class="card-body-theme">
                    <table class="table-dark-theme">
                        <tr>
                            <td>Aset</td>
                            <td class="text-end">Rp <?= number_format($neraca['aset']) ?></td>
                        </tr>
                        <tr>
                            <td>Liabilitas</td>
                            <td class="text-end">Rp <?= number_format($neraca['liabilitas']) ?></td>
                        </tr>
                        <tr>
                            <td>Modal</td>
                            <td class="text-end">Rp <?= number_format($neraca['modal']) ?></td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="btn-group">
                <button onclick="window.print()" class="btn-theme btn-outline-primary">Print</button>
                <a href="export-jurnal.php" class="btn-theme btn-outline-success">Export Excel</a>
            </div>
        </main>
    </div>
