...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .table-dark-theme th, .table-dark-theme td { padding: 0.85rem 1.25rem; border-bottom: 1px solid var(--border-color); text-align: left; vertical-align: middle; }
        ...
        .btn-group { margin: 1.5rem; text-align: center; }
        ...
        .btn-danger-sm { background-color: var(--danger-color); color: var(--text-primary); padding: 0.4rem 0.8rem; font-size: 0.8rem; }
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="jurnal.php" class="active" data-tooltip="Jurnal Umum"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 18.5V5h3v13.5c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5V5H13v13.5c0 .8.7 1.5 1.5 1.5s1.5-.7 1.5-1.5V5h3v13a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3z"/></svg></span></a></li>
        ...
        <main class="main-content">
            ...
            <div class="card-theme">
                <div class="card-header-theme">
                    Jurnal Umum - <?= htmlspecialchars($_SESSION['username']) ?>
                </div>
                <div class="card-body-theme no-padding">
                                ...
                                <?php if (count($jurnal) > 0): ?>
                                    <?php foreach ($jurnal as $row): ?>
                                        <tr>
                                            ...
                                            <td><a href="hapus-transaksi.php?id=<?= $row['id'] ?>" class="btn-theme btn-danger-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
